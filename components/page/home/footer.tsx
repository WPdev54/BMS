...
const Footer = () => {
  return (
    <div className="transition-all duration-200 ">
      <div className="w-full min-h-screen flex items-center justify-center gap-20 bg-black1">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
          ...
          <div className="flex mt-8 flex-col md:flex-col mx-auto md:justify-center ">
            <Button
              radius="full"
          ...
          <div className="flex flex-col">
            ...
            <p className="font-black text-2xl bg-clip-text text-transparent bg-gradient-to-tr from-purple-400 to-green-400">
              ...
              <Link href="#" className=" transition-all duration-250 capitalize hidden md:block cursor-pointer text-gray-600 hover:text-white w">
                About
              </Link>
              <Link href="#" className=" transition-all duration-250 capitalize hidden md:block cursor-pointer text-gray-600 hover:text-white w">
                Services
